                ...
                <form method="POST" action="{{ route('medicamentos.store') }}">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="flex">
                            ...
                            <input type="number" step="0.01" name="precio" id="precio" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-r-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                        </div>
                    </div>
